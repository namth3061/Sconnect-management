                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                        <div class="d-flex flex-wrap align-items-center">
                            ...
                            <div class="d-flex flex-wrap align-items-center mb-3 mb-sm-0">
                                <h4 class="me-2 h4">{{ $data->full_name ?? __('navigate.profile.austin_robertson')  }}</h4>
                                <span
                                    class="text-capitalize"> - {{ str_replace('_',' ',$authUser->username) ?? __('navigate.profile.marketing_administrator') }}</span>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <ul class="list-inline m-0 p-0">
                        <li class="d-flex mb-2">
                            ...
                            <p class="news-detail mb-0">there is a meetup in your city on fryday at 19:00. <a href="#">{{__('navigate.profile.see_details')}}</a></p>
                        </li>
                        <li class="d-flex">
                            <div class="news-icon me-3">
                                <svg width="20" viewBox="0 0 24 24">
                ...
                <div class="card-body">
                    <ul class="list-inline m-0 p-0">
                     ...
                     <span class="btn-inner">
                        ...
                        <li class="d-flex mb-4 align-items-center">
                            <div class="img-fluid bg-soft-dark rounded-pill"><img src="{{asset('images/icons/06.png')}}"
                                                                                  alt="story-img"
                                                                                  class="rounded-pill avatar-40"></div>
                            <div class="ms-3 flex-grow-1">
                                <h6>Jenny Wilson</h6>
                     ...
                     <span class="btn-inner">
                        ...
                        <li class="d-flex mb-4 align-items-center">
                            <div class="img-fluid bg-soft-info rounded-pill"><img src="{{asset('images/icons/04.png')}}"
                                                                                  alt="story-img"
                                                                                  class="rounded-pill avatar-40"></div>
                            <div class="ms-3 flex-grow-1">
                                <h6>Bessie Cooper</h6>
                     ...
                     <span class="btn-inner">
                        ...
                        <li class="d-flex align-items-center">
                            <div class="img-fluid bg-soft-info rounded-pill"><img src="{{asset('images/icons/08.png')}}"
                                                                                  alt="story-img"
                                                                                  class="rounded-pill avatar-40"></div>
                            <div class="ms-3 flex-grow-1">
                                <h6>Floyd Miles</h6>
