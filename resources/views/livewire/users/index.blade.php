                ...
                <div class="card-body px-0">
                    <div class="table-responsive">
                        <table id="user-list-table" class="table table-striped" role="grid"
                            ...
                            <tr class="ligth">
                                <th>STT</th>
                                <th>{{ __('users.table.first_name') }}</th>
                                <th>{{ __('users.table.last_name') }}</th>
                                <th>{{ __('users.table.username') }}</th>
                                <th>{{ __('users.table.phone_number') }}</th>
                                <th>{{ __('users.table.email') }}</th>
                                <th>{{ __('users.table.userProfile_country') }}</th>
                                <th>{{ __('users.table.status') }}</th>
                                <th>{{ __('users.table.image') }}</th>
