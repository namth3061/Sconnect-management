<ul class="navbar-nav iq-main-menu" id="sidebar">
    <li class="nav-item static-item">
        <a class="nav-link static-item disabled" href="#" tabindex="-1">
            <span class="default-icon">{{ __('navigate.vertical_nav.home') }}</span>
            <span class="mini-icon">-</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link {{ activeRoute(route('system.dashboard')) }}"
           aria-current="page"
           href="{{route('system.dashboard')}}">
            ...
            <span class="item-name">{{ __('navigate.vertical_nav.dashboard') }}</span>
        </a>
    </li>
    <li>
        <hr class="hr-horizontal">
    </li>
    @include('livewire.components.layouts._asset-vertical-nav')
    @include('livewire.components.layouts._crm-vertical-nav')
    @include('livewire.components.layouts._business-vertical-nav')
    <li class="nav-item static-item">
        <a class="nav-link static-item disabled" href="#" tabindex="-1">
            <span class="default-icon">{{ __('navigate.vertical_nav.managements') }}</span>
            <span class="mini-icon">-</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link {{ activeRoute(route('system.tenant')) }}" href="{{ route('system.tenant') }}">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <span class="item-name">{{ __('navigate.vertical_nav.tenant') }}</span>
        </a>
    </li>
</ul>
