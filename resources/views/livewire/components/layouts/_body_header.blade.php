<nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
    <div class="container-fluid navbar-inner">
        <a href="{{route('system.dashboard')}}" class="navbar-brand">
                    ...
                    <a class="nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown" role="button"
                       data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div class="caption ms-3 d-none d-md-block ">
                            <h6 class="mb-0 caption-title">{{ $authUser->username ?? __('navigate.profile.austin_robertson') }}</h6>
                            <p class="mb-0 caption-sub-title text-capitalize">{{ str_replace('_',' ',$authUser->username) ?? __('navigate.profile.marketing_administrator') }}</p>
                        </div>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        {{--                        <li><a class="dropdown-item" href="{{route('users.show', auth()->id() || 1)}}">Profile</a></li>--}}
                        <li><a class="dropdown-item" href="{{route('auth.lockscreen')}}">Lock Screen</a></li>
